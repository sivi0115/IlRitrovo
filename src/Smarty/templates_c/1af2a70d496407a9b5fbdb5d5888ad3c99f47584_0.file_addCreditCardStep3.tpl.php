<?php
/* Smarty version 5.5.1, created on 2025-06-27 00:48:30
  from 'file:addCreditCardStep3.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_685dce3e706440_92165916',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1af2a70d496407a9b5fbdb5d5888ad3c99f47584' => 
    array (
      0 => 'addCreditCardStep3.tpl',
      1 => 1750978104,
      2 => 'file',
    ),
  ),
...
function content_685dce3e706440_92165916 (\Smarty\Template $_smarty_tpl) {
    ...
    <body class="edit-background">
        ...
        <div class="modal">
            <div class="modal-content">
                ...
                <form method="post" action="/IlRitrovo/public/CreditCard/checkAddCreditCardStep3" class="card-form">
...
" <?php if ((true && (true && null !== ($_smarty_tpl->getValue('cardData')['type'] ?? null))) && $_smarty_tpl->getValue('cardData')['type'] == $_smarty_tpl->getValue('type')) {?>
                            selected<?php }?>><?php echo $_smarty_tpl->getValue('type');?>
</option>
                        <?php
}
...
">
                ...
                <p><a href="/IlRitrovo/public/Reservation/dataRoomReservation">Back to Step 3</a></p>
            </div> <!-- /.modal-content-->
        </div> <!-- /.modal-->
    </body>
</html><?php }
