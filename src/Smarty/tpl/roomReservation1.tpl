...
<html lang="en">
    ...
    <body>
        ...
        <div class="panel">
            ...
            <!-- Booking Form -->
            <form method="post" action="CFrontController.php?controller=CReservation&task=showValidRoom" class="booking-form">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="guests" id="guests" min="1" max="100" value="{$reservationData.guests|default:''}" required>
                </div> <!-- /.form-group-->
