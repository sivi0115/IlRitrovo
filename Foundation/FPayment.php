...
class FPayment
{
    ...
    {
        $requiredFields = ['idPayment', 'total', 'state', 'creationTime', 'idCreditCard'];
    ...
    public static function storePayment(EPayment $payment): bool
    {
        ...
        $data = [
            ...
            'creationTime' => $payment->getCreationTime()->format('Y-m-d H:i:s')
        ];
    ...
    {
        $validStates = [EPayment::STATE_COMPLETED, EPayment::STATE_PENDING, EPayment::STATE_FAILED, EPayment::STATE_CANCELED];
